...
import SelectorItemsPorPagina from './SelectorItemsPorPagina';
import Icon from './Icon';

const ControlesPaginacion = ({ servidores = [], itemsPerPage, setItemsPerPage, currentPage, setCurrentPage, isExportMenuOpen, setIsExportMenuOpen, exportMenuRef, exportarCSV, exportarExcel, userRole }) => {
    ...
    return (
        <div className="pagination-controls">
            <div className="pagination__items-per-page">
                ...
                <label>Mostrar:</label>
                <SelectorItemsPorPagina value={itemsPerPage} onChange={setItemsPerPage} />
            </div>
