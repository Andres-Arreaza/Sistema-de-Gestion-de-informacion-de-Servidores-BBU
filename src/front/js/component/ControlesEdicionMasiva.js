...
import DesplegableEdicionMasiva from './DesplegableEdicionMasiva';

const ControlesEdicionMasiva = ({ columnasEditables = [], opcionesColumnas = [], bulkEditValues = {}, handleBulkEditChange = () => { }, catalogos = {}, handleApplyBulkEdit = () => { } }) => {
...
export default ControlesEdicionMasiva;
