...
// ========================================================
// Iconos (Definidos aquí para ser autocontenidos)
// ========================================================
...
const ServidorCargaMasiva = ({ onClose, actualizarServidores }) => {
    ...
    const handleGuardar = async () => {
        ...
        try {
            ...
            onClose(); // Cierra el modal principal de carga masiva
            actualizarServidores('Carga masiva completada'); // Llama a la función para refrescar la lista de servidores
